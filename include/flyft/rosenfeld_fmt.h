...
class RosenfeldFMT : public Functional
    ...
    template<typename T>
    void computeProportionalByWeight(T& w0,
                                     T& w1,
                                     T& wv1,
                                     const T& w2,
                                     const T& wv2,
    ...
    void fourierTransformFieldSpherical(const Field::ConstantView& input, const Mesh* mesh) const;
    };

template<typename T>
void RosenfeldFMT::computeProportionalByWeight(T& w0,
                                               T& w1,
                                               T& wv1,
                                               const T& w2,
                                               const T& wv2,
