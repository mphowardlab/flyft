...
void bindIntegrator(py::module_& m)
    ...
    py::class_<Integrator, std::shared_ptr<Integrator>, IntegratorTrampoline>(m, "Integrator")
        ...
        .def_property("adaptive",
                      &Integrator::usingAdaptiveTimestep,
                      &Integrator::enableAdaptiveTimestep)
        .def_property("adapt_delay",
                      &Integrator::getAdaptiveTimestepDelay,
                      &Integrator::setAdaptiveTimestepDelay)
        .def_property("adapt_tolerance",
                      &Integrator::getAdaptiveTimestepTolerance,
                      &Integrator::setAdaptiveTimestepTolerance)
        .def_property("adapt_minimum",
                      &Integrator::getAdaptiveTimestepMinimum,
                      &Integrator::setAdaptiveTimestepMinimum);
    }
