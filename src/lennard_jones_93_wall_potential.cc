...
LennardJones93WallPotential::LennardJones93WallPotential(std::shared_ptr<DoubleParameter> origin,
                                                         double normal)
...
LennardJones93WallPotential::Function
LennardJones93WallPotential::makePotentialFunction(std::shared_ptr<State> state,
